...
class Usuario {
    ...
    void setId_usuario (String id_usuario) { this.id_usuario = id_usuario; }
    ...
    private static Usuario crearUsuario(Usuario usuario) throws IOException {
        ...
        usuario.setId_usuario (br.readLine());
    ...
    static class Servicio {
        ...
        private final static String URL_MAQUINA = "http://20.97.16.0:8080/Servicio/rest/ws/";
